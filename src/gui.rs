...
use super::{CombatStats, Player, gamelog::GameLog, Map, Name, Position, State, InBackpack, Viewshed, RunState, Equipped, HungerState, HungerClock};
...
pub fn draw_ui(ecs: &World, ctx : &mut Rltk) {
    ...
    ctx.print_color(2, 43, RGB::named(rltk::LIGHT_GRAY), RGB::named(rltk::BLACK), &depth);
...
pub fn main_menu(gs : &mut State, ctx : &mut Rltk) -> MainMenuResult {
    ...
    ctx.print_color_centered(20, RGB::named(rltk::YELLOW), RGB::named(rltk::BLACK), "Rust Roguelike");
