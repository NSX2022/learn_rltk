...
use super::{BuilderChain, CellularAutomataBuilder, XStart, YStart, AreaStartingPosition, CullUnreachable, VoronoiSpawning, DistantExit, BuilderMap, MetaMapBuilder};
...
impl YellowBrickRoad {
    ...
    fn build(&mut self, rng : &mut RandomNumberGenerator, build_data : &mut BuilderMap) {
        ...
        // Code for if you want the yellow road to be a viable path
